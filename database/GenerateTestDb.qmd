...
certification_type <- data.frame(
  ...
  certification_name = c("Firefighter I", "Firefighter II", "EMT", "AEMT", "CPR", "Wildland Firefighter 2"),
...
equipment <- data.frame(
  equipment_id = 1:8,
  equipment_name = c("Engine 1 Batteries", "Engine 2 Batteries", "Ladder 1 Batteries", 
                     "Engine 1", "Ladder 2",
