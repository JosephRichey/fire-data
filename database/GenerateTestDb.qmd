...
setting <- data.frame(
  setting_id = seq_along(unlist(Dispatch_Codes)),
  major_setting_key = "dispatch_code",
  minor_setting_key = rep(names(Dispatch_Codes), lengths(Dispatch_Codes)),
  setting_value = unlist(Dispatch_Codes)
)
...
setting <- setting |> 
  bind_rows(
    data.frame(
      setting_id = 48:59,
      major_setting_key = c("dispatch_seconds",
                            "dispatch_seconds",
                            "response_area",
                            "response_area",
                            "response_area",
                            ...
                            "dropped",
                            "address"),
      minor_setting_key = c("dispatch_time", 
      "end_time",
      "area",
      "area",
      "area",
